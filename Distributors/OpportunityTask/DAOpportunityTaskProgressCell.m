...
@interface DAOpportunityTaskProgressCell(){
...
@implementation DAOpportunityTaskProgressCell
...
- (UIImageView *)iconView{
    if (!_iconView) {
        ...
        UIImage *img = [UIImage imageNamed:@"IconBell"];
        img = [DSImage image:img withMaskColor:[AGStyleCoordinator colorTheme]];
...
- (AGLineProgressView *)progressView{
    if (!_progressView) {
        ...
        [_progressView setInnerViewBackgroundColor:RGBA(2, 145, 68, 1)];
